    ...
    if choice == '0':
        ...
        if choice == '1':
            ...
            for i in range(9):
                ...
                crawling_tag_data.append(getContent(driver))
        ...
        if choice == '2':
            ...
            user_data = [name, followers, followings]
            ...
            for i in range(9):
                crawling_user_data.append(getContent(driver))
                # store current post's data
...
data_output = pd.DataFrame(crawling_tag_data, columns = ['name', 'like', 'post date', 'current date', 'content', 'place', 'tags'])
...
follower_output = pd.DataFrame(follow_data, columns = ['name', 'followers', 'followings'])
# to handle large amount of data, use Dataframe supported by pandas
